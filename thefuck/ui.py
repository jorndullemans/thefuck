...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[thedick.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype hedick.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[thedick.types.CorrectedCommand]
    :rtype: thedick.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No dicks given' if get_alias() == 'dick'
                    else 'Nothing found')
        return
